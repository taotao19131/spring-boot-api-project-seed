...
import static com.taotao.project.core.ProjectConstant.*;
...
public class CodeGenerator {
	...
	private static final String AUTHOR = "taotao19131@gmail.com";//@author
	private static final String DATE = new SimpleDateFormat("yyyy/MM/dd").format(new Date());//@date

	public static void main(String[] args) {
		genCode("t_education", "t_labor_contract", "t_post", "t_qualification_certificate", "t_staff", "t_study",
				"t_study_certificate", "t_study_theme");
		//genCodeByCustomModelName("输入表名","输入自定义Model名称");
		//genCodeAllTable() 生成该数据库所有表的Model
	}

	/**
	 * 通过获取数据库所有表生成代码，Model 名称通过解析数据表名称获得，下划线转大驼峰的形式。
	 */
	public static void genCodeAllTable() {
		List<String> allTables = getAllTables();
		if (CollectionUtil.isEmpty(allTables)) {
			System.out.println(JDBC_URL + "这个数据库还没有任何表");
		}
	...
	public static List<String> getAllTables(){
		JDBCConnectionConfiguration jdbcConnectionConfiguration = getJdbcConnectionConfiguration();
		JDBCConnectionFactory factory = new JDBCConnectionFactory(jdbcConnectionConfiguration);
